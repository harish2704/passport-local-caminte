...
module.exports = function(schema, options) {
    options = options || {};
    options.saltlen = options.saltlen || 16;
    options.iterations = options.iterations || 10000;
    options.keylen = options.keylen || 32;
    ...
    schema.schema.extendModel( schema.modelName, schemaFields );

    schema.prototype.setPassword = function (password, cb) {
        if (!password) {
    ...
    schema.prototype.authenticate = function(password, cb) {
        var self = this;
    ...
    schema.findByUsername = function(username, cb) {
        ...
        this.findOne({where: queryParameters }, cb);
    };
